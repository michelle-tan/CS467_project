<template>
  <b-container fluid>
              ...
              <b-col offset-sm="1">
                <div class="text-justify">
                  ...
                  <b-container v-if="review.images !== 0">
                    ...
                    <b-modal v-model="showImageModal" centered>
                      ...
                      >
                        <div v-for="(img,index) in review.images" :key="index">
                          <b-carousel-slide :img-src="getPathToSrc(img)" class="img"/>
                        </div>
                      </b-carousel>
    ...
    <b-modal v-model="showUpdateModal" centered :title="'Editing Review:  ' + review.product.name">
      <ReviewForm
...
export default {
  ...
  computed: {
    ...
    numHalfStars() {
      return Math.ceil(this.review.rating) - Math.floor(this.review.rating) ===
        1
        ? 1
        : 0;
    },
